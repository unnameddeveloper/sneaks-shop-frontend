...
const FooterMenu = ({ active, setActive }) => {
  ...
  return (
    ...
    <div className="footermenu">
        <Link onClick={() => window.scrollTo(0, 0)} to='/' className="footermenu_link">
        ...
        <Link onClick={() => window.scrollTo(0, 0)} to='/catalog' className="footermenu_link">
        ...
        <Link onClick={() => window.scrollTo(0, 0)} to='/busket' className="footermenu_link">
        ...
        <Link onClick={() => window.scrollTo(0, 0)} to='/favorite' className="footermenu_link">
        ...
        <Link onClick={() => window.scrollTo(0, 0)} to='/account' className="footermenu_link">
